    ...
    >
      ...
      >
        <div className="flex flex-col glass-pearl p-12">
          ...
          <motion.div
            className="flex flex-wrap gap-12 md:gap-20 lg:gap-32 mt-16 md:mt-24 flex-col lg:flex-row md:flex-row sm:flex-col justify-center lg:justify-start md:justify-start sm:justify-center text-center lg:text-start md:text-start sm:text-center"
            initial={{ opacity: 0, y: 50 }}
            animate={inView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
            transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }}
          >
            <motion.div
              className="items-center flex lg:gap-6 md:gap-6 flex-col lg:flex-row md:flex-row"
